...
install -D  node_exporter-%{version}.linux-amd64/node_exporter    \
            %{buildroot}%{home_dir}/bin/node_exporter
...
%changelog
* Wed Oct 14 2020 Francisco Correia <fcorreia@users.noreply.github.com> - 1.0.1

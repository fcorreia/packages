...
Source4:	http://files.freeswitch.org/releases/sounds/%{name}-8000-%{version}.tar.gz.sha256
Source5:    http://files.freeswitch.org/releases/sounds/%{name}-16000-%{version}.tar.gz.sha256
Source6:    http://files.freeswitch.org/releases/sounds/%{name}-32000-%{version}.tar.gz.sha256
Source7:    http://files.freeswitch.org/releases/sounds/%{name}-48000-%{version}.tar.gz.sha256
BuildArch:	noarch
Requires:	freeswitch

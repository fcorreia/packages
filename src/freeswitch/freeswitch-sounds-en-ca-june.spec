...
Source4:    https://files.freeswitch.org/releases/sounds/%{name}-48000-%{version}.tar.gz.sha256
Source5:    https://files.freeswitch.org/releases/sounds/%{name}-32000-%{version}.tar.gz.sha256
Source6:    https://files.freeswitch.org/releases/sounds/%{name}-16000-%{version}.tar.gz.sha256
Source7:    https://files.freeswitch.org/releases/sounds/%{name}-8000-%{version}.tar.gz.sha256

...
#
######################################################################################################################
Source0:    https://github.com/signalwire/freeswitch/archive/refs/tags/v%{version}.tar.gz
...
#
######################################################################################################################
# Removed, build errors:  event_handlers/mod_kazoo
...
## Remove kazoo config until build issues solved
%{__rm} -f %{buildroot}/%{sysconfdir}/autoload_configs/kazoo.conf.xml
...
######################################################################################################################
%changelog
* Thu Mar 31 2022 Tux Skywaler <tux.skywalker@users.noreply.github.com> - 1.10.7
